...
CREATE TABLE IF NOT EXISTS `happyhouse`.`comment` (
  ...
  INDEX `qnano` (`qnano` ASC) VISIBLE,
  INDEX `userid` (`userid` ASC) VISIBLE,
  CONSTRAINT `comment_ibfk_1`
    FOREIGN KEY (`qnano`)
    REFERENCES `happyhouse`.`qna` (`qnano`)
    ON DELETE CASCADE,
...
-- -----------------------------------------------------
-- Table `happyhouse`.`covid_area`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `happyhouse`.`covid_area` (
  `gigwanno` INT NOT NULL AUTO_INCREMENT,
  `gugunCode` VARCHAR(10) NULL DEFAULT NULL,
  `gugunName` VARCHAR(45) NULL DEFAULT NULL,
  `gigwanName` VARCHAR(45) NULL DEFAULT NULL,
  `gigwanAddress` TEXT NULL DEFAULT NULL,
  `weekdayTime` TEXT NULL DEFAULT NULL,
  `saturdayTime` VARCHAR(45) NULL DEFAULT NULL,
  `sundayTime` VARCHAR(45) NULL DEFAULT NULL,
  `tel` VARCHAR(45) NULL DEFAULT NULL,
  `info` TEXT NULL DEFAULT NULL,
  `lat` VARCHAR(45) NULL DEFAULT NULL,
  `lng` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`gigwanno`))
ENGINE = InnoDB
AUTO_INCREMENT = 72
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `happyhouse`.`houseinfo` (
  ...
  `avgDealAmount` INT NULL DEFAULT NULL,
  `totalDealCount` INT NULL DEFAULT NULL,
  PRIMARY KEY (`aptCode`),
  INDEX `dongCode` (`dongCode` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `happyhouse`.`user_interest` (
  `user_id` VARCHAR(45) NOT NULL,
  `interest_dong` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;

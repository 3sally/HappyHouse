package com.ssafy.happyhouseproject;
...
//	http://localhost:8080/{your-app-root}/swagger-ui.html
	...
	private String title = "SSAFY HAPPYHOUSE " + version;
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).consumes(getConsumeContentTypes())
				...
				.apis(RequestHandlerSelectors.basePackage("com.ssafy.guestbook.controller")).paths(postPaths()).build()
